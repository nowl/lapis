...
static size_t font_cache_len = 0;
static size_t font_cache_cap = 0;

SDL_Surface **font_surfs = NULL;
static size_t font_surfs_len = 0;
static size_t font_surfs_cap = 0;
...
get_font(char *font_name, int pt_size)
{
    ...
    if(!found)
    {
        ...
        font_cache = memory_grow_to_size(font_cache,
                                         sizeof(*font_cache),
                                         &font_cache_cap,
                                         font_cache_len);
